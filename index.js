...
const gif = new Image();
gif.src = "./imagens/morreu.gif";

var video = document.createElement("video");

video.src = "./imagens/gif_lava.mp4";
// video.autoplay = true;

var videoFinal = document.createElement("video");

videoFinal.src = "./imagens/FINAL.mp4";
// videoFinal.autoplay = true;
...
frutaroxa2.src = "./bananas/frutaroxa01.png";

frutaroxa3 = new Image();
frutaroxa3.src = "./bananas/frutaroxa04.png";
...
raspberry1.src = "./bananas/raspberry1.png";

raspberry2 = new Image();
raspberry2.src = "./bananas/raspberry2.png";

raspberry3 = new Image();
raspberry3.src = "./bananas/raspberry3.png";

raspberry4 = new Image();
raspberry4.src = "./bananas/raspberry4.png";
...
class Background {
  ...
  constructor(x, y, width, height) {
    ...
    this.width = width;
    this.height = height;
    this.speed = 0.3; //Speed para incrementar na posição y
  }
...
const todasImagens = [
  ...
  [{ img1: frutaroxa1, img2: frutaroxa2, img3: frutaroxa3, img4: frutaroxa4 }],
  [{ img1: melancia1, img2: melancia2, img3: melancia3, img4: melancia4 }],
  [{ img1: raspberry1, img2: raspberry2, img3: raspberry3, img4: raspberry4 }],
];
...
const char = new Player(canvas.width / 2 - 20, 350, 34, 60, 0, 0);
...
function updateGame() {
  ...
  // console.log("game spee: " + game.frames)
  // console.log("fruits spee: " + Fruits.speed)
  ...
  function verificaEncostarFruta() {
    ...
    if (char.y >= canvas.height - 30) {
      char.y = 99999;
      video.play();
      ctx.drawImage(video, 0, 0, 400, 550);
    } else if (char.y <= -5) {
      char.y = -99999;
      videoFinal.play();
      ctx.drawImage(videoFinal, 0, 0, 400, 550);
    } else if (char.x >= canvas.width - 20) {
      char.x = 99999;
      video.play();
      ctx.drawImage(video, 0, 0, 400, 550);
    } else if (char.x <= -15) {
